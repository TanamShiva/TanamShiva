...
Today, I specialize in using SQL, Power BI, Excel, and Python to transform business data into actionable insights that support strategic and operational decisions.
...
Built a star-schema data model and interactive dashboard to track revenue, regional performance, and YoY KPIs - enabling clearer visibility into sales trends and performance gaps.

#### Amazon Sales Analysis (SQL)
Performed end-to-end analysis using joins, CTEs, and window functions to identify top-performing products, regional trends, and customer behavior insights.

#### Freelance Power BI Consulting
